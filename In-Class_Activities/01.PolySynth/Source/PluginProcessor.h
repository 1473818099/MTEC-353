...
private:
    ...
    void processMidiMessages (juce::MidiBuffer&);
    void controlADSR (juce::MidiMessage);
    
    // An array to manage multiple synth voices
    juce::OwnedArray<Synth> synths;
    
    // Max 10 synth voices
    static const int MAX_SYNTHS = 10;
